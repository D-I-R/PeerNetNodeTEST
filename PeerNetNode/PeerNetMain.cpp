...
BEGIN_MESSAGE_MAP(CPeerNetNodeApp, CWinApp)
  ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

// Создание CPeerNetNodeApp
...
// Единственный объект CPeerNetNodeApp
CPeerNetNodeApp theApp;

// Инициализация CPeerNetNodeApp
